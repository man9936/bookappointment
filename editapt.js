  ...
  class UI {
    ...
    static addBookToList(book) {
      ...
      row.innerHTML = `
        ...
        <td><a href="#" class="btn btn-toolbar btn-sm " >Edit</a></td>
...
////edit button
    static editbooking(name,phone,dateTime){
  ...
  document.querySelector("#book-list").addEventListener('click',(e) =>{
    if(e.target.classList==="btn btn-toolbar btn-sm "){
      UI.deleteBook(e.target);
      Store.removeBook(e.target.parentElement.previousElementSibling.textContent);
      UI.editbooking(e.target.parentElement.parentElement);
      }
  });
